...
public class CadastrarProduto extends javax.swing.JFrame {
    ...
    private void btnCadastroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastroActionPerformed
        Produto produto = new Produto(0 ,inputNome.getText(), inputDescricao.getText(),0);
        ProdutoController controller = new ProdutoController();
        int result = controller.cadastrarProduto(produto);
        if(result == 0){JOptionPane.showMessageDialog(this, "Produto cadastrado com sucesso!", "Aviso", JOptionPane.INFORMATION_MESSAGE);this.dispose();}
